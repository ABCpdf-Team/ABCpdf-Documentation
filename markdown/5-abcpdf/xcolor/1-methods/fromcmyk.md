...
```csharp
static <a href="../default.htm">XColor</a> FromCmyk(int cyan, int magenta, int yellow, int black)<br> static <a href="../default.htm">XColor</a> FromCmyk(double cyan, double magenta, double yellow, double black)
```

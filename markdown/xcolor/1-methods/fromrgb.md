...
```csharp
static <a href="../default.htm">XColor</a> FromRgb(int red, int green, int blue)<br> static <a href="../default.htm">XColor</a> FromRgb(double red, double green, double blue)
```
